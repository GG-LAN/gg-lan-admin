...
import DropdownNavLink from '@/Components/Navs/DropdownNavLink.vue';
</script>

<template>
    <aside id="sidebar" class="fixed top-0 left-0 z-40 flex flex-col flex-shrink-0 w-64 h-full pt-16 font-normal duration-75 lg:flex transition-transform -translate-x-full lg:translate-x-0" aria-label="Sidebar">
            ...
            <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                    <ul class="pb-2 space-y-2">
                        ...
                        <NavLink routename="payments.index" icon="money-bill" iconColor="green" activeFor="Payments">
                            Paiements
                        </NavLink>
