            ...
            <li v-for="item in breadcrumbs">
                ...
                <div class="flex items-center space-x-2" v-else>
                    ...
                    <div
                        ...
                        class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-md w-64 h-44 overflow-y-scroll dark:bg-gray-700 [&::-webkit-scrollbar-track]:rounded-e-lg [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-thumb]:rounded-full dark:[&::-webkit-scrollbar-track]:bg-gray-800 dark:[&::-webkit-scrollbar-thumb]:bg-gray-600 dark:[&::-webkit-scrollbar-thumb]:rounded-full"
                    >
                        <ul
