...
const submit = () => {
    form.delete(route('faqs.destroy', props.modelId), {
        preserveScroll: true,
        onSuccess: () => {
            props.drawer.hide()
        }
...
<template>
    <BoxDrawer :uid="'drawer-delete-' + props.uid" :title="props.title" :drawer="props.drawer">
        ...
        <h3 class="mb-6 text-lg text-gray-500 dark:text-gray-400">Êtes-vous sûr(e) de vouloir supprimer cette question ?</h3>
