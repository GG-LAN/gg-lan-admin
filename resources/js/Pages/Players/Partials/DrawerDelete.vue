...
const submit = () => {
    form.delete(route('players.destroy', props.modelId), {
        preserveScroll: true,
        onSuccess: () => {
            props.drawer.hide()
        }
...
<template>
    <BoxDrawer id="drawer-delete" :title="props.title" :drawer="props.drawer">
        ...
        <h3 class="mb-6 text-lg text-gray-500 dark:text-gray-400">Êtes-vous sûr(e) de vouloir supprimer ce joueur ?</h3>
